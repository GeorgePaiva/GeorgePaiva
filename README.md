...
### Sobre me
Sou um apaixonado pela linguagem Java, que está em constante evolução para trazer as melhores propostas para o desenvolvimento de API's. Habilidade na linguagem de programação Java, e foco na estrutura do ecossistema Spring, Spring Boot, Spring Data JPA e Spring Security. Usando especificação Java, JPA com implementação do HIBERNATE para a persistência de dados e mapeamento relacional, executando e organizando completamente todos os serviços que poderiam funcionar. [@java](https://www.java.com/pt-BR/).
